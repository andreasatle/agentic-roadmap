...
**AI & Agents**
LLM‑based agents (OpenAI SDK), RAG architectures, embeddings, evaluation harnesses, agent governance & safety

**Programming**
Python (primary), Go, C/C++, SQL

**Frameworks & APIs**
FastAPI, Flask, gRPC, REST, Pydantic v2

**Infrastructure & Data**
AWS, Docker, Kubernetes, ChromaDB, MySQL, SQLite

**Practices**
Schema‑driven design, cost‑aware inference, deterministic workflows, CI/CD, Git
